...
but see https://stackoverflow.com/questions/46021734/what-is-the-reason-for-stdresult-of-deprecated-in-c17
*/
#define str(x) #x

template <char const* fname, typename FooType, FooType func, typename... T>
typename std::result_of<FooType(T...)>::type
fs_exception_wrapper(T... args)
{
    try
    {
